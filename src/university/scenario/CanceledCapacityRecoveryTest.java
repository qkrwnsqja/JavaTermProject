...
/**
 * [시나리오 6] 폐강 후 정원 복구 안됨 검증
 */
public class CanceledCapacityRecoveryTest {

    // ⚠️ 아까 확인한 ID가 884번이었죠? (다르면 본인 DB에 맞게 수정 필요)
    ...
    public static void main(String[] args) {
        System.out.println("=================================================================");
        System.out.println("   [시나리오 6] 폐강 후 정원 복구 안됨 검증");
        System.out.println("=================================================================\n");
        ...
        try {
            ...
            // ★★★ [수정된 부분] 트랜잭션 수동 관리를 위해 자동 커밋 끄기 ★★★
            ...
            if (enrollmentId != null) {
                ...
                if (countAfterDelete == countAfterCancel) {
                    System.out.println("\n  ✅ [PASS] enrolled_count가 변하지 않았습니다! (폐강 정책 준수)");
                } else {
                    System.out.println("\n  ℹ️ enrolled_count가 감소했습니다. (일반 취소 로직 동작)");
                }
            }
