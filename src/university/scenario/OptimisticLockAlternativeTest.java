...
/**
 * 동시 UPDATE 충돌 (Optimistic Lock 대안)
 */
public class OptimisticLockAlternativeTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        System.out.println("=================================================================");
        System.out.println(" 동시 UPDATE 충돌 (Optimistic Lock 대안)");
        System.out.println("=================================================================");
        ...
        Thread threadA = new Thread(() -> {
            ...
            try {
                ...
                System.out.println("[Thread A] 비즈니스 로직 처리 중");
                Thread.sleep(2000);

                System.out.println("[Thread A] 정원 변경 시도");
        ...
        Thread threadB = new Thread(() -> {
            ...
            try {
                ...
                System.out.println("[Thread B] 비즈니스 로직 처리 중");
                Thread.sleep(3000);

                System.out.println("[Thread B] 정원 변경 시도");
                String sqlUpdate = "UPDATE open_course SET capacity = ?, version = version + 1 " +
                        "WHERE open_course_id = ? AND version = ?";
